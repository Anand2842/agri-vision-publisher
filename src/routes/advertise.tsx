      ...
      <main id="main-content">
        ...
        <section className="bg-navy text-white py-20 relative overflow-hidden">
          ...
          <div className="container-editorial relative z-10">
            <div className="max-w-3xl">
              ...
              <h1 className="font-display text-2xl md:text-3xl leading-[1.05] text-white">
              ...
              <p className="mt-6 text-white/80 text-lg leading-relaxed font-sans">
                {getAdvertise("hero", "body") ||
                  "Agro-based industrial and other allied sectors can advertise in The Agriculture Popular Article Magazine. Write to us for placements, rate cards and partnership enquiries."}
              </p>
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <Link
                  to="/contact"
                  className="border border-white/30 hover:border-white px-6 py-3 rounded-sm text-sm font-sans tracking-wide transition-colors"
                >
                  Contact Office
                </Link>
              </div>
        ...
        <section className="container-editorial py-20">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <h2 className="font-display text-4xl mt-3 text-ink">
              Connect With Key Decision Makers
            </h2>
            <p className="text-foreground/70 mt-4 leading-relaxed">
              Our magazine bridges the gap between scientific agricultural research and on-farm
              applications. Align your brand with agricultural progress and sustainability.
            </p>
          </div>
        ...
        <section className="bg-paper border-y border-rule py-16">
          <div className="container-editorial text-center">
            ...
            <h2 className="font-display text-3xl mt-2 mb-10 text-ink">
              Our Growing Agricultural Reader Network
            </h2>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-4xl mx-auto">
              {stats.map((s, i) => (
                <div
                  key={i}
                  className="p-4 border-r border-rule last:border-0 max-lg:[&:nth-child(2n)]:border-r-0"
                >
                  <div className="font-display text-4xl font-bold text-primary">{s.value}</div>
                  <div className="text-xs uppercase tracking-wider text-muted-foreground mt-1 font-semibold">
                    {s.label}
                  </div>
                </div>
              ))}
        ...
        <section id="packages" className="container-editorial py-20">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-foreground/70 mt-4 leading-relaxed">
              Select a sponsorship program that fits your corporate outreach goals. All packages can
              be tailored to meet specific branding initiatives.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {packages.map((pkg, idx) => (
              ...
              >
                {pkg.highlighted && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-primary text-white text-xs uppercase tracking-wider px-3 py-1 font-semibold rounded-full font-sans">
                    Most Popular
                  </div>
                )}
                <div>
                  <h3 className="font-display text-2xl text-ink mb-2">{pkg.name}</h3>
                  <div className="font-sans text-sm font-semibold text-primary mb-4">
                    {pkg.price}
                  </div>
        ...
        <section className="bg-navy text-white border-t border-rule py-16">
          <div className="container-editorial text-center max-w-3xl">
            ...
            <h2 className="font-display text-3xl md:text-4xl text-white">
              Get in Touch with our Editorial Office
            </h2>
            <p className="text-white/80 mt-4 leading-relaxed font-sans max-w-xl mx-auto">
              Ready to advertise? Request a comprehensive media kit and discussion regarding custom
              marketing schedules.
            </p>
