    ...
    <section className="relative h-[68vh] min-h-[480px] max-h-[760px] w-full overflow-hidden bg-navy">
      ...
      <div className="relative h-full flex flex-col items-center justify-center text-center px-6">
        <h1 className="font-script text-white text-5xl sm:text-6xl md:text-8xl drop-shadow-lg">
          Welcome to The Agriculture Popular Article Magazine
        </h1>
  ...
  return (
    <section className="container-editorial py-16 md:py-24">
      <div className="hr-divider mb-8">
        <h2 className="section-title text-2xl md:text-4xl text-center">The Agriculture Popular Article Magazine</h2>
      </div>
      <p className="max-w-4xl mx-auto text-center text-foreground/75 leading-[1.9] text-[0.97rem]">
        The Agriculture Popular Article Magazine is a peer-reviewed, open access monthly magazine, initiated for the
        ...
        addressing current and future needs. The Agriculture Popular Article Magazine also aims at providing a
  ...
  return (
    <section className="container-editorial py-16 md:py-24">
      ...
      <p className="max-w-4xl mx-auto text-center text-foreground/75 leading-[1.9] text-[0.97rem]">
        ...
        the farming sector has become very important; consequently, The Agriculture Popular Article Magazine helps
...
const testimonials = [
  ...
  {
    quote:
      "The Agriculture Popular Article Magazine has become required reading in our extension office. Practical, peer-reviewed, beautifully produced.",
